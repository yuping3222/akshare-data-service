"""Basic types and utility classes for cross-layer sharing.

Provides:
- RequestStats: Request statistics for a single data source
- CacheStats: Cache hit/miss statistics
- StatsCollector: Thread-safe singleton for collecting runtime statistics
- Helper functions for logging API requests and data quality issues

This is the canonical location for these types.
The old `akshare_data.core.stats` is a compatibility shell.
"""
