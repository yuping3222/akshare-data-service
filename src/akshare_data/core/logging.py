"""
结构化日志模块 - JSON 日志配置、JoinQuant 适配

合并来源:
- akshare-one-enhanced: logging_config.py (StructuredFormatter, ContextFilter, setup_logging, get_logger, LogContext, log_exception)
- jk2bt: logging/ 目录 (formatters, handlers, adapters, manager)
"""
...
# Re-export stats module items for backward compatibility
...
__all__ = [
    ...
    # Helpers
    "log_exception",
    # Re-exports from stats (backward compat)
    "RequestStats",
    "CacheStats",
    "StatsCollector",
    "get_stats_collector",
...
# ============================================================================
# Formatters (合并 akshare-one + jk2bt)
# ============================================================================
...
class StructuredFormatter(logging.Formatter):
    ...
    (来自 akshare-one logging_config.py)
    """
...
class StandardFormatter(logging.Formatter):
    """Standard log formatter using predefined format constants. (来自 jk2bt)"""
...
class JSONFormatter(logging.Formatter):
    """JSON log formatter outputting structured log records. (来自 jk2bt)"""
...
def get_formatter(format_type: str = "standard") -> logging.Formatter:
    """Return a formatter based on the specified format type. (来自 jk2bt)"""
    formatters = {
...
# ============================================================================
# JQLogAdapter (来自 jk2bt logging/adapters.py)
# ============================================================================
...
# ============================================================================
# Logging Config (来自 jk2bt logging/config.py)
# ============================================================================
...
# ============================================================================
# LogManager (来自 jk2bt logging/manager.py)
# ============================================================================
...
# ============================================================================
# setup_logging (主入口 - 合并 akshare-one + jk2bt)
# ============================================================================
...
def setup_logging(
    ...
    合并 akshare-one 和 jk2bt 的日志配置逻辑。
    ...
    Args:
        ...
        format_type: Format style ("structured", "standard", "simple", "json", "strategy")
        json_format: Whether to use JSON format (backward compat)
        max_bytes: Max bytes per log file before rotation
        backup_count: Number of backup log files to keep
        default_context: Default context to add to all log records
        suppress_third_party: Suppress noisy third-party loggers
...
# ============================================================================
# Helper logging functions (来自 akshare-one)
# ============================================================================
...
def setup_logging_simple(
    ...
    """Convenience function to set up logging (来自 jk2bt)."""
    setup_logging(
        log_level=level,
        log_file=log_file,
