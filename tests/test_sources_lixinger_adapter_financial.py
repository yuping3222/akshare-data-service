...
class TestLixingerCorporateAction:
    ...
    def test_get_equity_pledge(self, adapter):
        if adapter.is_configured():
            df = adapter.get_equity_pledge(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")
            assert isinstance(df, pd.DataFrame)
        else:
            with pytest.raises(Exception):
                adapter.get_equity_pledge(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")

    @pytest.mark.integration
    def test_get_restricted_release(self, adapter):
        if adapter.is_configured():
            df = adapter.get_restricted_release(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")
            assert isinstance(df, pd.DataFrame)
        else:
            with pytest.raises(Exception):
                adapter.get_restricted_release(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")
    ...
    def test_get_block_deal(self, adapter):
        if adapter.is_configured():
            df = adapter.get_block_deal(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")
            assert isinstance(df, pd.DataFrame)
        else:
            with pytest.raises(Exception):
                adapter.get_block_deal(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")

    @pytest.mark.integration
    def test_get_margin_data(self, adapter):
        if adapter.is_configured():
            df = adapter.get_margin_data(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")
            assert isinstance(df, pd.DataFrame)
        else:
            with pytest.raises(Exception):
                adapter.get_margin_data(symbol="000001", start_date="2024-01-01", end_date="2024-02-01")
...
class TestLixingerInfoDisclosure:
    ...
    def test_get_performance_forecast_empty(self, mock_client, adapter_with_mock_client):
    ...
    def test_get_performance_forecast_with_dates(self, mock_client, adapter_with_mock_client):
    ...
    def test_get_research_report_with_dates(self, mock_client, adapter_with_mock_client):
